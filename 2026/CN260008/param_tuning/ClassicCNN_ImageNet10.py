...
# 参考精度: AlexNet ImageNet-1k Top1 准确率 62.5%
# CUDA_VISIBLE_DEVICES=0 wandb agent city945/WandbTest/d2e13xnj --count 24
import torch
...
def parse_args():
    ...
    parser.add_argument('--init_weight',default=True, help='init weight')
    parser.add_argument('--use_bias',   default=True, help='use bias')
...
def main():
    ...
    model = eval(args.modelname)(num_classes=10, init_weights=args.init_weight, use_bias=args.use_bias).to(device)
