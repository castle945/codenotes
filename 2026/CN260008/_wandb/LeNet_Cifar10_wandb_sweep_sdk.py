...
# wandb sweep --project WandbTest LeNet_Cifar10_random_search.yaml
# python3 LeNet_Cifar10_wandb_sweep_sdk.py --sweep_id city945/WandbTest/86tpmbd4 --sweep_num_runs 36 # 与 grid_search 搜索相同次数
import torch
...
if __name__ == '__main__':
    ...
    if args.sweep_id is not None:
        ...
        wandb.agent(args.sweep_id, partial(main, args), count=args.sweep_num_runs)
    else:
        main(args)
