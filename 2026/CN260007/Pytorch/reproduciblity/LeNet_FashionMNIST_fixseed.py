...
def parse_args():
    ...
    parser.add_argument('--epochs',     default=1,   type=int,   help='number of epoch in training')
...
def main():
    ...
    all_eval_results = []
    # set_random_seed(666) # 设置在这里无效，必须尽早设置，因为某些初始化操作可能也会用到随机数
